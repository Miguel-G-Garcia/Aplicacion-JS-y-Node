...
/**
 * Realiza peticiones AJAX de reservation GET
 * @param {string} url 
...
async function peticionGET(url, parametros) {
    ...
    oURL.pathname += url; // por ejemplo "/clients/:id"
...
/**
 * Realiza peticiones AJAX de reservation DELETE
 * @param {string} url 
 * @param {FormData} parametros - Objeto FormData con los parámetros de la llamada 
 * @returns 
 */
async function peticionDELETE(url){
    // Creamos el objeto URL que contiene la dirección url de la petición
    console.log("La url de la petición delete "+url);
...
/**
 * Realiza peticiones AJAX de reservation POST enviando datos JSON
 * @param {string} url 
